...
class CameraFrame(customtkinter.CTkFrame):
    def __init__(self, master, go_back_callback=None):
        ...
        self.title_label = customtkinter.CTkLabel(
            self, text="Sign Language Translator",
            font=("Bahnschrift", 32, "bold"), text_color="#10b981"
        )
        ...
        self.current_letter_label = customtkinter.CTkLabel(
            content_frame, text="–", font=("Bahnschrift", 48, "bold"),
            text_color="#facc15", width=80, height=60, fg_color="#333333", corner_radius=10
        )
        ...
        right_title = customtkinter.CTkLabel(right_panel, text="Erkannte Buchstaben", font=("Roboto", 16, "bold"), text_color="#94a3b8")
        right_title.grid(row=0, column=0, pady=(15, 5), padx=10)

        self.sentence_textbox = customtkinter.CTkTextbox(
            right_panel, font=("Bahnschrift", 22), text_color="#10b981",
            fg_color="#1e1e1e", corner_radius=8, wrap="word"
        )
        ...
        self.confirmed_hint = customtkinter.CTkLabel(right_panel, text="Halte ein Zeichen 3s lang", font=("Roboto", 11), text_color="#64748b")
    ...
    def copy_to_clipboard(self):
        ...
        if content:
            ...
            self.after(1000, lambda: self.confirmed_hint.configure(text="Halte ein Zeichen 3s lang", text_color="#64748b"))
